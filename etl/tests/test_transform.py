...
@pytest.mark.parametrize("infra_data, expected_score", [
    # Cenário 1: Escola perfeita, score 0.0
    ({"possui_saneamento_basico": True, "possui_agua_potavel": True, "possui_biblioteca": True, "possui_internet": True, "possui_quadra_esportes": True, "possui_acessibilidade_pcd": True}, 0.0),
    # Cenário 2: Sem biblioteca e sem quadra, score 0.30 (20 + 10)
    ({"possui_saneamento_basico": True, "possui_agua_potavel": True, "possui_biblioteca": False, "possui_internet": True, "possui_quadra_esportes": False, "possui_acessibilidade_pcd": True}, 0.30),
    # Cenário 3: Sem saneamento e sem água, score 0.45 (25 + 20)
    ({"possui_saneamento_basico": False, "possui_agua_potavel": False, "possui_biblioteca": True, "possui_internet": True, "possui_quadra_esportes": True, "possui_acessibilidade_pcd": True}, 0.45),
    # Cenário 4: Faltando tudo, score 1.0
    ({"possui_saneamento_basico": False, "possui_agua_potavel": False, "possui_biblioteca": False, "possui_internet": False, "possui_quadra_esportes": False, "possui_acessibilidade_pcd": False}, 1.0),
    # Cenário 5: Faltando apenas acessibilidade, score 0.10
    ({"possui_saneamento_basico": True, "possui_agua_potavel": True, "possui_biblioteca": True, "possui_internet": True, "possui_quadra_esportes": True, "possui_acessibilidade_pcd": False}, 0.10),
])
...
def test_finalize_schema():
    ...
    data = {
        "escola_id_inep": [1], "escola_nome": ["Escola A"], "municipio_id_ibge": [123],
        "municipio_nome": ["Cidade A"], "estado_sigla": ["PB"], "dependencia_adm": ["Municipal"],
        "tipo_localizacao": ["Urbana"], "infraestrutura": [{}], "indicadores": [{}],
        "localizacao": [{}], "score_de_risco": [0.5], "coluna_extra_1": ["lixo"],
        "latitude": [0.0] 
    }
