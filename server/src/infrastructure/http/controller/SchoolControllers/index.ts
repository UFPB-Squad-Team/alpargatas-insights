...
export const getAllSchoolsController = new GetAllSchoolsController(getAllSchoolsUseCase)
export const getSchoolDetailsController = new GetSchoolDetailsController(getSchoolDetailsUseCase)
export const getSchoolsByDependenciaAdministrativaController = new GetSchoolsByDependenciaAdministrativaController(getSchoolsByDependenciaAdministrativaUseCase)
export const listSchoolsForMapController = new ListSchoolsForMapController(listSchoolsForMapUseCase)
export const searchSchoolsController = new SearchSchoolsController(searchSchoolsUseCase)