...
const getMunicipalityStatisticsUseCase = new GetMunicipalityStatisticsUseCase(schoolRepository)

const getMunicpalityWithIbgeCodeUseCase = new GetMunicipalityWithIbgeCodeUseCase(municipalityRepository)

const listMunicpalitiesUseCase = new ListMunicipalitiesUseCase(municipalityRepository)

export const getMunicipalityStatisticsController = new GetMunicipalityStatisticsController(getMunicipalityStatisticsUseCase)

export const getMunicipalityWithIbgeCodeController = new GetMunicipalityWithIbgeCodeController(getMunicpalityWithIbgeCodeUseCase)

export const listMunicipalitiesController = new ListMunicipalitiesController(listMunicpalitiesUseCase)