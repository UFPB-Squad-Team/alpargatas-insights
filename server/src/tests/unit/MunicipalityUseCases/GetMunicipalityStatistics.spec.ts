...
describe("GetMunicipalityStatisticsUseCase", () => {
    it("Get statistics without errors", async () => {
        ...
        const getMunicipalityStatisticsUseCase = new GetMunicipalityStatisticsUseCase(mockSchoolRepository)
        ...
        await expect(getMunicipalityStatisticsUseCase.execute(schoolData)).rejects.toMatchObject({
