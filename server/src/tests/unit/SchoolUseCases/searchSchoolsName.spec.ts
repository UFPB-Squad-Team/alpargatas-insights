...
describe("SearchSchoolsNameUseCase", () => {
    ...
    const mockSchoolRepository = {
      ...
      save: jest.fn(),
        ...
        const searchSchoolsNameUseCase = new SearchSchoolsUseCase(mockSchoolRepository)
    ...
    const mockSchoolRepository = {
      ...
      save: jest.fn(),
        ...
        await expect(searchSchoolsNameUseCase.execute(schoolData)).rejects.toMatchObject({
