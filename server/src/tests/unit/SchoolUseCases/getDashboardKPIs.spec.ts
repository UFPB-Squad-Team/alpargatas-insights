...
describe("GetDashboardKPIsUseCase", () => {
    it("Get all KPIs without errors", async () => {
        ...
        const getDashboardKPIsUseCase = new GetDashboardKPIsUseCase(mockSchoolRepository, mockMunicipalityRepository)

        expect(await getDashboardKPIsUseCase.execute()).toEqual({ schools: 2, schoolsWithHighInfraestructureRisk: [{           id: "esc-001",
                    municipioId: "mun-002",
                    codigoInep: 12345678,
                    nome: "Escola Municipal Professora Ana Silva",
                    municipioNome: "João Pessoa",
                    ...
                    infraestrutura: {
                        ...
                        possui_ar_condicionado: false,
                        possui_esgoto: false
                    }}], municipalitiesWithMostSchoolsInHighRisk: [], lackName: "possui_ar_condicionado" })
    })
})